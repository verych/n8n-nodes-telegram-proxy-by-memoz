...
import { addAdditionalFields, addReplyMarkup, apiRequest, getPropertyName } from './GenericFunctions';
...
export class TelegramProxy implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Telegram (Proxy)',
		name: 'telegramProxy',
